...
public interface MasterDao {
	...
	String userManageScopeServiceDao(String username, String groupname, String location, String admin, String dashboard,
			String report, String graph);

	List<UserManageScopeModel> viewUserManageScopeDao();

	String deleteUserManageScopeDao(long ID);

	String mailTemplateDao(String templateName, String subject, String sendTime, String ipAddressList,
	...
	String deleteMailTemplateDao(Long SR_NO);

	JSONArray viewMailTemplateDao(String userScopeData);

	MailTemplateBean mailTemplateBeanDao(Long SR_NO);

	String updateMailTemplateDao(String templateName, String subject, String sendTime, String ipAddressList,
			String functionName, String msgBody, String attachment, String toMail, String periods,
			String attachmentType, String ccMail, String days, String isActive, Long SR_NO, String phone);

	Map<String, String> getDistinctNodes(String userScopeData);

	String addPushConfigurationDao(String templateName, String command, Timestamp datepicker, String status,
			String ip_address);

//		List<PushConfigurationModel> viewPushConfigurationDao();

	String getTemplateName();

	String fetchCommandDao(String option);
	...
	ConfigBackupBean ConfigBackupBeanDao(long ID);

	String updateConfigurationBackupDao(String deviceIp, String deviceMode, String confCommand, String foCommand,
			long ID);

	String addScheduleScanDao(String scheduleType, String startIp, String subnetIp, String once_time);

	JSONArray viewScheduleScanDao();

	String deleteScheduleScanDao(long ID);

	SNMPConfigMasterBean fetchSMNPConfigDao(String deviceIp, String snmp);
	...
	JSONArray getManualTopology(String string, String contextPath);
