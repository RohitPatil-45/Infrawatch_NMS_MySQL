...
public class NodeReportServiceImpl implements NodeReportService {
	...
	public JSONArray LinkLatencystatusreport(String from_date, String to_date,
			List<String> list) {
		// TODO Auto-generated method stub
	...
	public JSONArray LinkaverageLatencyReportView(String from_date, String to_date,
			List<String> list , String Status) {
		// TODO Auto-generated method stub
		return dao.LinkaverageLatencyReportView(from_date, to_date, list,Status);
	}

	public JSONArray LinkAvailabilityReportView(String from_date, String to_date,
			List<String> list) {
		// TODO Auto-generated method stub
	...
	public JSONArray LinkBandwidthHistoryReportView(String from_date, String to_date,
			List<String> list) {
		// TODO Auto-generated method stub
		return dao.LinkBandwidthHistoryReportView(from_date, to_date, list);
	}

	public JSONArray LinkAVGBandwidthReportView(String from_date, String to_date,
			List<String> list) {
		// TODO Auto-generated method stub
