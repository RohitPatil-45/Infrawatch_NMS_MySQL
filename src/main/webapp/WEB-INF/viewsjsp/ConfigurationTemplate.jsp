					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<!--<form id="quickForm">-->
								<form:form method="post" id="configTemplateFrom"
									modelAttribute="fetchConfigTemplateData">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:textarea path="command" name="command"
														class="form-control" placeholder="Enter Command"></form:textarea>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-footer">
										<button type="button" id="addConfigurationTemplates"
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									...
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Configuration Template Details</h3>
										</div>
										<!-- /.card-header -->
										<div class="card-body">
