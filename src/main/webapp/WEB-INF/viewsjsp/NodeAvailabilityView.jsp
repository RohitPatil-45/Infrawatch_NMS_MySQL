...
<title>Node Availability Report | DataTables</title>
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a
									href="<%=request.getContextPath()%>/nodeReport/nodeAvailabilityForm">Node
						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Node Availability Report</h3>
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											<c:forEach var="report" items="${statusReportData}">
												<tr>
													...
													<td>${report.UPTIME_PERCENT}</td>
													<td>${report.UPTIME}</td>
													<td>${report.DOWNTIME_PERCENT}</td>
										...
										<tfoot>
											<tr>
												...
												<th>Node IP</th>
												<th>Uptime Percent</th>
												<th>Uptime Miliseconds</th>
												<th>Downtime percent</th>
												<th>Downtime Miliseconds</th>
