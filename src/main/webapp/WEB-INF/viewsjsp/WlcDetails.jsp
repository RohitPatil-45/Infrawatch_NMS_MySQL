					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<c:choose>
									<c:when test="${userId==null}">
										<li class="breadcrumb-item active">WLC Details</li>
									</c:when>
									<c:otherwise>
										<li class="breadcrumb-item active">Edit WLC Details</li>
									</c:otherwise>
								</c:choose>
			...
			<div class="container" style="margin-left: 10px; min-width: 100%;">
				<ul id="myUL"
					...
					<li style="font-size: 20px;"><span class="caret caret-down"><i
							class="fas fa-desktop"></i>&nbsp; WLC Devices</span>
										...
										<div class="default-tab">
											<ul class="nav nav-tabs" role="tablist">
												<li class="nav-item"><a class="nav-link active"
													data-toggle="tab" href="#home">WLC Details </a></li>
												<li class="nav-item" id="HWConfigurationdefaultID"><a
													class="nav-link" data-toggle="tab" href="#profile">Access Point Details</a></li>
												<li class="nav-item"><a class="nav-link"
													data-toggle="tab" href="#contact">SSID Details</a></li>
												<li class="nav-item" id="PatchDetailsdefaultID"><a
													class="nav-link" data-toggle="tab" href="#patch">Client Details</a></li>
												<li class="nav-item"><a class="nav-link"
