...
<body class="hold-transition layout-top-nav">
		...
		<nav
			...
			<div class="container">
				<a href="<%=request.getContextPath()%>/dashboard/summaryPage"
					...
					<%-- 					src="<%=request.getContextPath()%>/webtemplate/dist/img/infrawatchJpeg.jpeg" --%>
					<!-- 					class="brand-image"">  --> <!-- <span class="brand-text font-weight-light">NPM</span> -->
					<!-- 					<span class="brand-text font-weight-bold">TARANG</span> -->
					<img width="120"
					src="<%=request.getContextPath()%>/webtemplate/dist/img/InfrawatchMain1.png"
					class="">
				</a>
				...
				<div class="collapse navbar-collapse order-3" id="navbarCollapse">
					...
					<ul class="navbar-nav">
							...
							<ul aria-labelledby="adminDropdownSubMenu"
								...
								<li class="dropdown-submenu dropdown-hover"><a
									...
									<ul aria-labelledby="adminDropdownSubMenu1"
										...
										<li><a tabindex="-1"
											href="<%=request.getContextPath()%>/master/collector"
											class="dropdown-item">Netflow/SFlow Collector</a></li>
								...
								<li class="dropdown-submenu dropdown-hover"><a
									...
									<ul aria-labelledby="adminDropdownSubMenu1"
										...
										<li><a tabindex="-1"
											...
											class="dropdown-item">Network Troubleshooting Template</a></li>
										<li><a tabindex="-1"
						...
						<li class="nav-item dropdown"><a id="adminDropdownSubMenu"
							...
							<ul aria-labelledby="dashboardDropdownSubMenu"
								...
								<li><a
									...
									class="dropdown-item">Process Monitoring</a></li>
								<li><a
						...
						<li class="nav-item dropdown"><a id="adminDropdownSubMenu"
							href="#" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false" class="nav-link dropdown-toggle">WLC</a>
							<ul aria-labelledby="dashboardDropdownSubMenu"
								class="dropdown-menu border-0 shadow">
								<li><a
									href="<%=request.getContextPath()%>/dashboard/serverMonitoringDashboard"
									class="dropdown-item">Dashboard</a></li>
								<li><a
									href="<%=request.getContextPath()%>/dashboard/wlcDetails"
									class="dropdown-item">WLC Details</a></li>

							</ul></li>

						<li class="nav-item dropdown"><a id="adminDropdownSubMenu"
							href="#" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false" class="nav-link dropdown-toggle">BGP
								Monitoring</a>
							<ul aria-labelledby="dashboardDropdownSubMenu"
								class="dropdown-menu border-0 shadow">
								<li><a tabindex="-1"
								...
								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/node/routesHistory"
									class="dropdown-item">BGP Routes History</a></li>
								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/node/topBgpActivity"
									class="dropdown-item">TOP BGP Events</a></li>
							</ul></li>
						...
						<li class="nav-item dropdown"><a id="reportDropdownSubMenu"
							href="#" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false" class="nav-link dropdown-toggle">Trouble
								Shooting</a>
							<ul aria-labelledby="adminDropdownSubMenu1"
								class="dropdown-menu border-0 shadow">
								...
								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/master/ping"
									class="dropdown-item">Ping(ICMP/SNMP/Proxy)</a></li>
								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/master/traceRoute"
									class="dropdown-item">Tracert/Traceroute</a></li>
								<!-- 								<li><a tabindex="-1" -->
								<%-- 									href="<%=request.getContextPath()%>/nodeReport/latencyHisotryGraphForm" --%>
								<!-- 									class="dropdown-item">Browse</a></li> -->
								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/master/SSH"
									class="dropdown-item">Telnet/SSH</a></li>

								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/master/pushConfiguration"
									class="dropdown-item">Network Troubleshooting PlayBooks</a></li>

								<li><a tabindex="-1"
									href="<%=request.getContextPath()%>/node/configTemplate"
									class="dropdown-item">Network Troubleshooting PlayBooks
										Manage</a></li>
								<!-- 								<li><a tabindex="-1" -->
								<%-- 									href="<%=request.getContextPath()%>/nodeReport/latencyGraphForm" --%>
								<!-- 									class="dropdown-item">Remote Desktop</a></li> -->
								<!-- 								<li><a tabindex="-1" -->
								<%-- 									href="<%=request.getContextPath()%>/nodeReport/latencyGraphForm" --%>
								<!-- 									class="dropdown-item">Terminal</a></li> -->
								<!-- 								<li><a tabindex="-1" -->
								<%-- 									href="<%=request.getContextPath()%>/nodeReport/latencyGraphForm" --%>
								<!-- 									class="dropdown-item">IT workflow automation</a></li> -->
							</ul></li>
					</ul>
				...
				<ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
					...
					<span id="sessionUserstore" style="display: none;"><%=sessionUser%></span>
					<span id="ContextPathId" style="display: none;"><%=request.getContextPath()%></span>
				</ul>
			</div>
		</nav>
		<!-- /.navbar -->
    ...
    // Check if the session variable is null or undefined
