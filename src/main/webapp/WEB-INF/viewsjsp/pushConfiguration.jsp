...
<body class="hold-transition layout-top-nav">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<form method="post" id="pushConfigurationid">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													<label for="exampleInputPassword1">DateTime</label> <input
														type="datetime-local" id="datepicker" name="group_name"
														class="form-control required" placeholder="yyyy-mm-dd" />
												</div>
												<div class="form-group">
													<label for="exampleInputPassword1">Commands</label>
													<textarea id="command" class="form-control required"
														placeholder="Commands"></textarea>
												</div>

												<div class="form-group">
													<label for="exampleInputEmail1">Group Name</label>
													<form:select name="group_name" id="group_name" type="text"
														path="groupName" class="form-control select2 required"
									...
									<div class="card-footer">
										<button type="submit" id="pushConfigurationSubmit"
											class="btn btn-primary">Submit</button>
										<i class="fa fa-spinner fa-spin"
											style="font-size: 24px; display: none;" id="speedLoadercheck"></i>
	...
	<script
		src="<%=request.getContextPath()%>/custom_js/pushConfiguration.js"></script>
	<script>
		$(function() {
			//Timepicker
